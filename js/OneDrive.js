          ...
          (function (
            ...
            var OneDriveApp = (function () {
              ...
              OneDriveApp.open = function (options) {
                ...
                if (!options) {
                  ErrorHandler_1.throwError(
                    new OneDriveSdkError_1.default(
                      ErrorType_1.default.unknown,
            ...
            require("./models/ErrorType"),
            require("./utilities/Logging"),
            require("./models/OneDriveSdkError"),
            require("./controllers/Picker"),
            require("./controllers/Saver")
          );
        },
        {
        ...
        function (require, module, exports) {
          (function (
            ...
            function getItem(item, apiRequestConfig, queryParameters) {
              var getRequestUrl = buildPathToItem(
                item,
                apiRequestConfig.apiEndpointUrl
              );
              if (queryParameters) {
                getRequestUrl = UrlUtilities_1.appendToPath(
                  getRequestUrl,
                  "?" + queryParameters
                );
              }
              var xhr = new XHR_1.default({
                ...
                headers: {
                  Authorization: "bearer " + apiRequestConfig.accessToken,
                },
              });
              Logging_1.default.logMessage(
                "performing GET on item with id: " + item.id
              );
                ...
                xhr.start(
                  ...
                  function (xhr, statusCode, timeout) {
                    reject({
                      errorCode:
                        ErrorType_1.default[
                          ErrorType_1.default.webRequestFailure
                        ],
            ...
            function getItems(items, apiRequestConfig, queryParameters) {
              ...
              for (var _i = 0, _a = items.value; _i < _a.length; _i++) {
                var item = _a[_i];
                filesPromises.push(
                  getItem(item, apiRequestConfig, queryParameters)
                );
              }
              return es6_promise_1.Promise.all(filesPromises).then(
            ...
            function shareItem(item, apiRequestConfig, createLinkParameters) {
              var shareRequestUrl = UrlUtilities_1.appendToPath(
                buildPathToItem(item, apiRequestConfig.apiEndpointUrl),
                StringUtilities_1.format(
                  "{0}.createLink",
                  apiRequestConfig.apiActionNamingSpace
                )
              );
              var xhr = new XHR_1.default({
                url: shareRequestUrl,
              ...
              return new es6_promise_1.Promise(function (resolve, reject) {
                xhr.start(
                  function (xhr, statusCode, url) {
                    Logging_1.default.logMessage(
                      StringUtilities_1.format(
                        "POST createLink succeeded via path {0}",
                        shareRequestUrl
                      )
                    );
                  ...
                  function (xhr, statusCode, timeout) {
                    Logging_1.default.logMessage(
                      StringUtilities_1.format(
                        "POST createLink failed via path {0}",
                        shareRequestUrl
                      )
                    );
                    reject({
            ...
            function shareItems(items, apiRequestConfig, createLinkParameters) {
              ...
              for (var _i = 0, _a = items.value; _i < _a.length; _i++) {
                var item = _a[_i];
                sharePromises.push(
                  shareItem(item, apiRequestConfig, createLinkParameters)
                );
              }
              return es6_promise_1.Promise.all(sharePromises).then(
                function (successFiles) {
                  processedFiles.value = successFiles;
                  return processedFiles;
                },
            ...
            function saveItemByFormUpload(
              ...
              return new es6_promise_1.Promise(function (resolve, reject) {
                if (window["File"] && file instanceof window["File"]) {
                  ...
                  reject(
                    new OneDriveSdkError_1.default(
                      ErrorType_1.default.unsupportedFeature,
                      "FileReader is not supported in this browser"
                    )
                  );
                }
                reader.onerror = function (event) {
                  Logging_1.default.logError(
                    "failed to read or upload the file",
                    event
                  );
                  reject(
                    new OneDriveSdkError_1.default(
                      ErrorType_1.default.fileReaderFailure,
                      "failed to read or upload the file, see console log for details"
                    )
                  );
                };
                reader.onload = function (event) {
                  var uploadUrl = UrlUtilities_1.appendToPath(
                    buildPathToItem(folder, apiRequestConfig.apiEndpointUrl),
                    "children('" + itemDescription.name + "')/content"
                  );
                  var queryParameters = {};
                  queryParameters["@name.conflictBehavior"] =
                    itemDescription["@name.conflictBehavior"];
                  var requestHeaders = {};
                  requestHeaders["Authorization"] =
                    "bearer " + apiRequestConfig.accessToken;
                  requestHeaders["Content-Type"] = "multipart/form-data";
                  var xhr = new XHR_1.default({
                    url: UrlUtilities_1.appendQueryStrings(
                      uploadUrl,
                      queryParameters
                    ),
                    clientId: apiRequestConfig.clientId,
            ...
            function saveItemByUriUpload(
              ...
              if (
                apiRequestConfig.apiEndpoint ===
                  ApiEndpoint_1.default.filesV2 ||
                apiRequestConfig.apiEndpoint === ApiEndpoint_1.default.graph_odb
              ) {
                return new es6_promise_1.Promise(function (resolve, reject) {
                  reject(
                    new OneDriveSdkError_1.default(
              ...
              requestHeaders["Authorization"] =
                "bearer " + apiRequestConfig.accessToken;
              itemDescription[
                getContentSourceUrl(apiRequestConfig.apiEndpoint)
              ] = sourceUri;
              ...
              if (UrlUtilities_1.isPathDataUrl(sourceUri)) {
                ...
                return saveItemByHttpUrlUpload(xhr).then(function (location) {
                  return beginPolling(location).then(function (resourceId) {
                    ...
                    return getItem(file, apiRequestConfig).then(
                      function (file) {
                        var response = {
                          webUrl: null,
                          value: [file],
            ...
            function getUserTenantUrl(apiRequestConfig) {
              var queryUrl = UrlUtilities_1.appendQueryString(
                UrlUtilities_1.appendToPath(
                  apiRequestConfig.apiEndpointUrl,
                  "me"
                ),
                "$select",
              ...
              return new es6_promise_1.Promise(function (resolve, reject) {
                xhr.start(
                  function (xhr, statusCode) {
                    var response = ObjectUtilities_1.deserializeJSON(
                      xhr.responseText
                    );
                    if (response.mySite) {
                      ...
                      reject(
                        new OneDriveSdkError_1.default(
                          ErrorType_1.default.badResponse,
                          StringUtilities_1.format(
                    ...
                    reject(
                      new OneDriveSdkError_1.default(
                        ...
                        StringUtilities_1.format(
                          ...
                          XHR_1.default.statusCodeToString(statusCode),
                          xhr.responseText
                        )
                      )
                    );
                  ...
                  function (xhr, statusCode) {
                    if (statusCode === 200 || statusCode === 201) {
                      var uploadedFile = {
                        webUrl: null,
                        value: [
                          ObjectUtilities_1.deserializeJSON(xhr.responseText),
                        ],
                      };
                ...
                xhr.start(
                  function (xhr, statusCode) {
                    switch (statusCode) {
                      case 202:
                      case 200:
                        var successResponse = ObjectUtilities_1.deserializeJSON(
                          xhr.responseText
                        );
            ...
            function buildPathToItem(item, apiEndpointUrl) {
              ...
              if (item.parentReference && item.parentReference.driveId) {
                subPath = UrlUtilities_1.appendToPath(
                  "drives",
              ...
              subPath = UrlUtilities_1.appendToPath(
                subPath,
                item.id === ROOT_ID ? "root" : "items/" + item.id
              );
            ...
            require,
            exports,
            require("../models/ApiEndpoint"),
            require("../models/ErrorType"),
            require("../utilities/Logging"),
            require("../utilities/ObjectUtilities"),
            require("../models/OneDriveSdkError"),
            require("../utilities/StringUtilities"),
            require("../utilities/UrlUtilities"),
            require("../utilities/XHR"),
            require("es6-promise")
          );
        },
        {
          ...
          (function (
            ...
            var Invoker = (function () {
              ...
              Invoker.prototype.launch = function (switchAccount) {
                var _this = this;
                return this.buildOauthPromise(switchAccount)
                  ...
                  .then(function (response) {
                    ...
                    if (response.type === "switch") {
                      ...
                      if (
                        !invokerOptions.needAPICall() ||
                        (isMicrosoftApp &&
                          invokerOptions.accessToken.toLowerCase() === "rps")
                      ) {
                        if (_this.invokerOptions.forceAuthenticate) {
                          _this.apiRequestConfig = _this.buildApiConfig();
                        }
                        successPromise =
                          es6_promise_1.Promise.resolve(successResponse);
                      } else {
                        _this.apiRequestConfig = _this.buildApiConfig();
                      ...
                      return successPromise.then(function (files) {
                        ...
                        if (_this.apiRequestConfig) {
                          files.apiEndpoint =
                            _this.apiRequestConfig.apiEndpointUrl;
                        } else if (
                          _this.loginHint &&
                          _this.loginHint.endpointHint ===
                            DomainHint_1.default.aad
                        ) {
              ...
              Invoker.prototype.buildOauthPromise = function (switchAccount) {
                ...
                if (switchAccount || this.invokerOptions.needOauth()) {
                  oauthPromise = Oauth_1.auth(
                    Oauth_1.buildOauthConfig(
                      this.invokerOptions,
                      switchAccount
                    ),
                    this.popup
              ...
              Invoker.prototype.buildPickerUI = function (oauthResponse) {
                ...
                if (oauthResponse) {
                  ...
                  loginHint = LoginCache_1.updateLoginHint(
                  ...
                  if (
                    this.invokerOptions.endpointHint !==
                      DomainHint_1.default.msa &&
                    this.invokerOptions.endpointHint !==
                      DomainHint_1.default.tenant
                  ) {
                    ErrorHandler_1.throwError(
                      new OneDriveSdkError_1.default(
                        ErrorType_1.default.optionsError,
                  ...
                  loginHint = {
                    loginHint: null,
                    timeStamp: null,
                    apiEndpoint: isConsumerAccount
                      ? ApiEndpoint_1.default.msa
                      : ApiEndpoint_1.default.filesV2,
                    endpointHint: isConsumerAccount
                      ? DomainHint_1.default.msa
                      : DomainHint_1.default.tenant,
                ...
                if (loginHint.apiEndpoint === ApiEndpoint_1.default.graph_odb) {
                  tenantPromise = ApiRequest_1.getUserTenantUrl(
                    this.buildApiConfig()
                  );
                } else {
                ...
                return tenantPromise.then(function (tenantUrl) {
                  _this.pickerUX = PickerUX_1.generatePickerUX(
                    loginHint.apiEndpoint,
                    loginHint.endpointHint === DomainHint_1.default.tenant
                      ? _this.invokerOptions.siteUrl
                      : tenantUrl
                  );
                  var pickerUXConfig = _this.buildPickerUXConfig(
                    _this.invokerOptions
                  );
                  if (_this.invokerOptions.navEntryLocation) {
                    pickerUXConfig.entryLocation =
                      _this.invokerOptions.navEntryLocation;
                  }
                  if (_this.invokerOptions.navSourceTypes) {
                    pickerUXConfig.sourceTypes =
                      _this.invokerOptions.navSourceTypes;
                  }
                  ...
                  return _this.pickerUX.invokePickerUX(
                    pickerUXConfig,
                    _this.popup
                  );
                });
              ...
              Invoker.prototype.buildApiConfig = function () {
                if (!this.loginHint) {
                  ErrorHandler_1.throwError(
                    new OneDriveSdkError_1.default(
                      ErrorType_1.default.internalError,
                ...
                switch (this.loginHint.apiEndpoint) {
                  ...
                  case ApiEndpoint_1.default.filesV2:
                    apiEndpointUrl = UrlUtilities_1.appendToPath(
        ...
        function (require, module, exports) {
          (function (
            ...
            function getLoginHint(invokerOptions) {
              ...
              var loginHint =
                loginCache[LOGINHINT_ITEM_PREFIX + invokerOptions.clientId];
              if (!loginHint) {
                return null;
              }
              ...
              if (
                invokerOptions.loginHint &&
                invokerOptions.loginHint !== loginHint.loginHint
              ) {
                return null;
              }
              return loginHint;
            ...
            function loginHintExpired() {
              ...
              return (
                new Date().getTime() - loginHint.timeStamp >
            ...
            function parseIdToken(idToken) {
              ...
              var urlFriendlyValue = userInfoPart
                .replace("-", "+")
                .replace("_", "/");
              var userInfo = ObjectUtilities_1.deserializeJSON(
                atob(urlFriendlyValue)
              );
      ...
      7: [
        function (require, module, exports) {
          (function (
            ...
            var AAD_OAUTH_ENDPOINT =
              "https://login.microsoftonline.com/common/oauth2/authorize";
            var AADV2_OAUTH_ENDPOINT =
              "https://login.microsoftonline.com/common/oauth2/v2.0/authorize";
            var MSA_OAUTH_ENDPONT =
            ...
            function onAuth() {
              DomUtilities_1.onDocumentReady(function () {
                ...
                var isOauth =
                  !!redirResults[PARAM_OAUTH_CONFIG] ||
                  ((!!redirResults[PARAM_ERROR] ||
                    !!redirResults[PARAM_ACCESS_TOKEN]) &&
                    !!redirResults[PARAM_STATE]);
                if (isOauth && window.opener) {
                  handleOauth(
                    redirResults,
                    new Channel_1.default(window.opener)
                  );
                }
              });
            }
            ...
            function handleOauth(redirResults, channel) {
              ...
              if (redirResults[PARAM_OAUTH_CONFIG]) {
                redirectToOauthPage(
                  JSON.parse(redirResults[PARAM_OAUTH_CONFIG])
                );
              } else if (redirResults[PARAM_ERROR]) {
                sendResponseToParent(
                  generateErrorResponse(redirResults),
                  channel
                );
              } else if (redirResults[PARAM_ACCESS_TOKEN]) {
                sendResponseToParent(
                  generateSuccessResponse(redirResults),
                  channel
                );
              }
            }
            ...
            function generateErrorResponse(redirResults) {
              var error = new OneDriveSdkError_1.default(
                ErrorType_1.default.badResponse,
                redirResults[PARAM_ERROR_DESCRIPTION]
              );
              return {
                type: "error",
                error: error,
            ...
            function sendResponseToParent(response, channel) {
              if (response.state) {
                ...
                if (channel) {
                  channel.send(
                    OAUTH_RESPONSE_HEADER + JSON.stringify(response),
                    "*"
                  );
                } else {
                  ErrorHandler_1.throwError(
                    new OneDriveSdkError_1.default(
                      ErrorType_1.default.popupOpen,
                  ...
                  ErrorHandler_1.throwError(
                    new OneDriveSdkError_1.default(
                      ...
                      "received bad oauth endpoint, endpoint value is: " +
                        oauthConfig.endpoint
                    )
                  );
                  break;
              }
              if (oauthConfig.switchAccount) {
                url = UrlUtilities_1.appendQueryString(
                  url,
                  "prompt",
                  "select_account"
                );
                ...
                url = UrlUtilities_1.appendQueryString(
                  url,
                  "login_hint",
                  oauthConfig.loginHint
                );
                url = UrlUtilities_1.appendQueryString(
                  url,
                  "domain_hint",
                  oauthConfig.isConsumerAccount ? "consumers" : "organizations"
                );
              }
            ...
            function buildAADOauthV2Url(config) {
              var scope =
                ...
                config.scopes
                  ...
                  .join(" ");
              var url = UrlUtilities_1.appendQueryStrings(
            ...
            function buildMSAOauthUrl(config) {
              ...
              for (var _i = 0, _a = config.scopes; _i < _a.length; _i++) {
                ...
                needWritePermission =
                  needWritePermission ||
                  scope.toLowerCase().indexOf("readwrite") > 1;
              }
              return UrlUtilities_1.appendQueryStrings(MSA_OAUTH_ENDPONT, {
                ...
                scope:
                  "onedrive." +
                  (needWritePermission ? "readwrite" : "readonly"),
              });
            }
            function auth(config, popupView) {
              var state =
                document.location.origin + "_" + UrlUtilities_1.generateNonce();
              config.state = state;
              return new es6_promise_1.Promise(function (resolve, reject) {
                var listenerId = DomUtilities_1.onMessage(function (event) {
                  if (
                    event.data &&
                    event.data.indexOf(OAUTH_RESPONSE_HEADER) === 0
                  ) {
                    var responseData = JSON.parse(
                      event.data.substring(OAUTH_RESPONSE_HEADER.length)
                    );
                    if (
                      responseData.state === state &&
                      event.source === popupView.getPopupWindow()
                    ) {
                      DomUtilities_1.removeMessageListener(listenerId);
                      if (responseData.type === "error" || responseData.error) {
                        var errorCode =
                          ErrorType_1.default[responseData.error.errorCode];
                        reject(
                          new OneDriveSdkError_1.default(
                            errorCode,
                ...
                return popupView
                  .openPopup(
                    UrlUtilities_1.appendQueryString(
                      config.redirectUri,
                      PARAM_OAUTH_CONFIG,
            ...
            function buildOauthConfig(invokerOptions, switchAccount) {
              ...
              var scopes = invokerOptions.scopes.map(function (s) {
                return (
                  s +
                  (s.indexOf("Files.") > -1 &&
                  invokerOptions.needSharePointPermission
                    ? ".All"
                    : "")
                );
              });
              ...
              if (invokerOptions.loginHint) {
                ...
                oauthConfig.isConsumerAccount =
                  invokerOptions.isConsumerAccount;
              } else if (loginHint) {
            ...
            require,
            exports,
            require("../utilities/Channel"),
            require("../models/DomainHint"),
            require("../utilities/DomUtilities"),
            require("../utilities/ErrorHandler"),
            require("../models/ErrorType"),
            require("./LoginCache"),
            require("../models/OauthEndpoint"),
            require("../models/OneDriveSdkError"),
            require("es6-promise"),
            require("../utilities/UrlUtilities")
          );
      ...
      8: [
        function (require, module, exports) {
          (function (
            ...
            var Picker = (function (_super) {
              ...
              Picker.prototype.buildPickerUXConfig = function (pickerOptions) {
                var pickerUXConfig = {
                  ...
                  selectionMode: pickerOptions.multiSelect
                    ? "multiple"
                    : "single",
              ...
              Picker.prototype.makeApiRequest = function (files) {
                if (
                  ...
                  PickerActionType_1.default.share
                ) {
                  return this.shareItems(files);
                } else {
                  var isDownload =
                    this.invokerOptions.action ===
                    PickerActionType_1.default.download;
              ...
              Picker.prototype.queryItems = function (files, isDownload) {
                var itemQuery =
                  ...
                  Constants_1.default.DEFAULT_QUERY_ITEM_PARAMETER;
                if (isDownload) {
                  itemQuery = StringUtilities_1.format(
                    "{0}{1}{2}",
                    itemQuery,
                    itemQuery.indexOf("select") === -1 ? "&select=" : ",",
                    "name,size,@content.downloadUrl"
                  );
                }
                return ApiRequest_1.getItems(
                  files,
              ...
              Picker.prototype.shareItems = function (files) {
                ...
                var createLinkParameters =
                  pickerOptions.createLinkParameters ||
                  this.getDefaultSharingConfig();
                return ApiRequest_1.getItems(
                  files,
                  this.getApiRequestConfig()
                ).then(function (files) {
                  return ApiRequest_1.shareItems(
                    files,
                    _this.getApiRequestConfig(),
              ...
              Picker.prototype.getDefaultSharingConfig = function () {
                ...
                if (
                  this.getApiRequestConfig().apiEndpoint ===
                    ApiEndpoint_1.default.graph_odc ||
                  this.getApiRequestConfig().apiEndpoint ===
                    ApiEndpoint_1.default.msa
                ) {
            ...
            require("./Invoker"),
            require("../utilities/ObjectUtilities"),
            require("../models/PickerOptions"),
            require("../models/PickerActionType"),
            require("../utilities/StringUtilities"),
            require("../utilities/UrlUtilities")
          );
        },
            ...
            var PickerUX = (function () {
              function PickerUX(apiEndpoint, tenantUrl) {
                if (
                  ...
                  this.url = UrlUtilities_1.appendQueryStrings(
                    CUSTOMER_PICKER_BASE_URL,
                    { v: "2" }
                  );
                } else if (
                  apiEndpoint === ApiEndpoint_1.default.graph_odb ||
                  ...
                  if (apiEndpoint === ApiEndpoint_1.default.graph_odb) {
                    tenantUrl = UrlUtilities_1.appendToPath(
                      tenantUrl,
                      "_layouts/onedrive.aspx"
                    );
                  }
                  this.url = UrlUtilities_1.appendQueryString(
                    tenantUrl,
                    "p",
                    "2"
                  );
              ...
              PickerUX.prototype.invokePickerUX = function (
                uxConfig,
                popupView
              ) {
                var _this = this;
                var pickerUXPromise = new es6_promise_1.Promise(function (
                  resolve,
                  reject
                ) {
                  var channelId = DomUtilities_1.onMessage(function (event) {
                    ...
                    var channel = new Channel_1.default(
                      _this.iframe
                        ...
                        : popupView.getPopupWindow()
                    );
                    if (event.origin === urlParts[0] + "//" + urlParts[2]) {
                      var message = "" + (event.data || "");
                      if (
                        message.indexOf(RESPONSE_PREFIX) === 0 &&
                        event.source === channel.getReceiver()
                      ) {
                        var response = JSON.parse(
                          message.substring(RESPONSE_PREFIX.length)
                        );
                        var pickerId = response.pickerId,
                  ...
                  var pickerOption = {
                    ...
                    ss: uxConfig.parentDiv
                      ? false
                      : uxConfig.accountSwitchEnabled,
                    tf: uxConfig.trapFocus,
                    cm: uxConfig.commandMode,
                  };
                  var pickerUrl = UrlUtilities_1.appendQueryString(
                    _this.url,
                    "picker",
                    JSON.stringify(pickerOption)
                  );
                  Logging_1.default.logMessage(
                    "invoke picker with url: " + pickerUrl
                  );
          ...
          (function (
            ...
            var Saver = (function (_super) {
              ...
              Saver.prototype.makeApiRequest = function (files) {
                ...
                if (
                  this.invokerOptions.action === SaverActionType_1.default.query
                ) {
                  var itemQuery =
                    this.invokerOptions.queryParameters ||
                    Constants_1.default.DEFAULT_QUERY_ITEM_PARAMETER;
                  ...
                  saverOptions.uploadType === UploadType_1.default.dataUrl ||
                  saverOptions.uploadType === UploadType_1.default.url
                ) {
                  var uploadItemDescription = { name: saverOptions.fileName };
                  return ApiRequest_1.saveItemByUriUpload(
                    files.value[0],
                    uploadItemDescription,
                    saverOptions.sourceUri,
                    this.apiRequestConfig
                  );
                } else if (
                  saverOptions.uploadType === UploadType_1.default.form
                ) {
                  var uploadItemDescription = {
                    name: saverOptions.fileName,
                    "@name.conflictBehavior": saverOptions.nameConflictBehavior,
                  };
                  return ApiRequest_1.saveItemByFormUpload(
                    files.value[0],
                    uploadItemDescription,
                    saverOptions.fileInput,
                    this.apiRequestConfig,
                    saverOptions.progress
                  );
                }
              };
              return Saver;
            ...
            require("./Invoker"),
            require("../utilities/ObjectUtilities"),
            require("../models/SaverActionType"),
            require("../models/SaverOptions"),
            require("../models/UploadType"),
            require("../utilities/UrlUtilities")
          );
        },
        {
        ...
        function (require, module, exports) {
          (function (require, exports) {
            ...
            (function (ErrorType) {
              ...
              ErrorType[(ErrorType["fileReaderFailure"] = 1)] =
                "fileReaderFailure";
              ErrorType[(ErrorType["popupOpen"] = 2)] = "popupOpen";
              ErrorType[(ErrorType["unknown"] = 3)] = "unknown";
              ErrorType[(ErrorType["unsupportedFeature"] = 4)] =
                "unsupportedFeature";
              ErrorType[(ErrorType["webRequestFailure"] = 5)] =
                "webRequestFailure";
      ...
      14: [
        function (require, module, exports) {
          (function (
            ...
            "use strict";
            Object.defineProperty(exports, "__esModule", { value: true });
            var AAD_APPID_PATTERN = new RegExp(
            ...
            var InvokerOptions = (function () {
              function InvokerOptions(options) {
                ...
                this.clientId = TypeValidators_1.validateType(
                  options.clientId,
                  Constants_1.default.TYPE_STRING
                );
                var cancelCallback = TypeValidators_1.validateCallback(
                  options.cancel,
                  true
                );
                ...
                var errorCallback = TypeValidators_1.validateCallback(
                  options.error,
                  true
                );
                this.error = function (error) {
                  if (errorCallback) {
                    CallbackInvoker_1.invokeAppCallback(
                      errorCallback,
                      true,
                      error
                    );
                ...
                this.redirectUri =
                  this.redirectUri ||
                  UrlUtilities_1.trimUrlQuery(window.location.href);
                this.endpointHint =
                  this.endpointHint || DomainHint_1.default.aad;
                var apiEndpointHint =
                  options.advanced && options.advanced.endpointHint;
                this.resource = apiEndpointHint
                  ? UrlUtilities_1.getOrigin(apiEndpointHint)
                  : undefined;
                this.forceAuthenticate =
                  options.advanced && options.advanced.forceAuthenticate;
              ...
              InvokerOptions.prototype.parseAdvancedOptions = function (
                options
              ) {
                if (options.advanced) {
                  if (!!options.advanced.redirectUri) {
                    UrlUtilities_1.validateRedirectUrlHost(
                      options.advanced.redirectUri
                    );
                    this.redirectUri = options.advanced.redirectUri;
                  }
                  if (!!options.advanced.queryParameters) {
                    var itemQueries = UrlUtilities_1.readUrlParameters(
                      "?" + options.advanced.queryParameters
                    );
                    for (var key in itemQueries) {
                      if (
                        key.toLowerCase() !== "select" &&
                        key.toLowerCase() !== "expand"
                      ) {
                        ErrorHandler_1.throwError(
                          new OneDriveSdkError_1.default(
                            ErrorType_1.default.optionsError,
                    ...
                    if (selectQuery && expandQuery) {
                      this.queryParameters = StringUtilities_1.format(
                        "expand={0}&select={1}",
                        expandQuery,
                        selectQuery
                      );
                      ...
                      if (
                        "select=" + selectQuery.split(",").sort().join(",") !==
                        Constants_1.default.DEFAULT_QUERY_ITEM_PARAMETER
                      ) {
                        this.queryParameters = StringUtilities_1.format(
                          "select={0}",
                  ...
                  if (!!options.advanced.endpointHint) {
                    if (
                      options.advanced.endpointHint.toLowerCase() ===
                      Constants_1.default.VROOM_ENDPOINT_HINT
                    ) {
                      this.endpointHint = DomainHint_1.default.msa;
                      if (
                        typeof options.advanced.isConsumerAccount ===
                        "undefined"
                      ) {
                        this.isConsumerAccount = true;
                      }
                    } else {
                      var domainHint = TypeValidators_1.validateType(
                        options.advanced.endpointHint,
                        "string",
                        false
                      );
                  ...
                  if (!!options.advanced.iframeParentDiv) {
                    if (
                      !options.advanced.iframeParentDiv.nodeName ||
                      options.advanced.iframeParentDiv.nodeName.toLowerCase() !==
                        "div"
                    ) {
                      ErrorHandler_1.throwError(
                        new OneDriveSdkError_1.default(
              ...
              InvokerOptions.prototype.parseNavigationOptions = function (
                navigation
              ) {
                if (navigation) {
                  ...
                  if (entryLocation) {
                    if (entryLocation.sharePoint) {
                      var _a = entryLocation.sharePoint,
                        sitePath = _a.sitePath,
                        listPath = _a.listPath;
                      if (sitePath) {
                  ...
                  var sourceTypes =
                    navigation.sourceTypes instanceof Array
                      ? navigation.sourceTypes
                      : navigation.sourceTypes
                        ? [navigation.sourceTypes]
                        : null;
                  if (!!sourceTypes) {
                    this.needSharePointPermission = !(
                      ...
                      sourceTypes[0].toLowerCase() === "onedrive"
                    );
            ...
            require,
            exports,
            require("../utilities/CallbackInvoker"),
            require("../Constants"),
            require("./DomainHint"),
            require("../utilities/ErrorHandler"),
            require("./ErrorType"),
            require("../utilities/Logging"),
            require("./OneDriveSdkError"),
            require("../utilities/StringUtilities"),
            require("../utilities/TypeValidators"),
            require("../utilities/UrlUtilities")
          );
        },
        {
          ...
          (function (require, exports, ErrorType_1, StringUtilities_1) {
            ...
            var OneDriveSdkError = (function (_super) {
              ...
              OneDriveSdkError.prototype.toString = function () {
                return StringUtilities_1.format(
          ...
          (function (
            ...
            var PickerOptions = (function (_super) {
              ...
              function PickerOptions(options) {
                ...
                var successCallback = TypeValidators_1.validateCallback(
                  options.success,
                  false
                );
                ...
                _this.multiSelect = TypeValidators_1.validateType(
                  options.multiSelect,
                  Constants_1.default.TYPE_BOOLEAN,
                  true,
                  false
                );
                var actionName = TypeValidators_1.validateType(
                  options.action,
                  Constants_1.default.TYPE_STRING,
                  true,
                  PickerActionType_1.default[PickerActionType_1.default.query]
                );
                _this.action = PickerActionType_1.default[actionName];
                _this.viewType = TypeValidators_1.validateType(
                  options.viewType,
                  Constants_1.default.TYPE_STRING,
                  true,
                  "files"
                );
                _this.accountSwitchEnabled = TypeValidators_1.validateType(
                  options.accountSwitchEnabled,
                  Constants_1.default.TYPE_BOOLEAN,
                  true,
                  true
                );
                _this.commandMode = TypeValidators_1.validateType(
                  options.commandMode,
                  Constants_1.default.TYPE_STRING,
                  true
                );
                ...
                if (options.advanced) {
                  _this.createLinkParameters =
                    options.advanced.createLinkParameters;
                }
                if (!_this.scopes) {
                  _this.scopes = [
                    _this.action === PickerActionType_1.default.share
                      ? "Files.ReadWrite"
                      : "Files.Read",
                  ];
                }
              ...
              PickerOptions.prototype.needAPICall = function () {
                return (
                  ...
                  this.action !== PickerActionType_1.default.query
                );
              };
            ...
            require("../utilities/CallbackInvoker"),
            require("../Constants"),
            require("./InvokerOptions"),
            require("../utilities/Logging"),
            require("./PickerActionType"),
            require("../utilities/TypeValidators")
          );
        },
        {
          ...
          (function (
            ...
            var SaverOptions = (function (_super) {
              ...
              function SaverOptions(options) {
                ...
                var progressCallback = TypeValidators_1.validateCallback(
                  options.progress,
                  true
                );
                ...
                var actionName = TypeValidators_1.validateType(
                  ...
                  Constants_1.default.TYPE_STRING,
                  true,
                  SaverActionType_1.default[SaverActionType_1.default.query]
                );
                ...
                _this.nameConflictBehavior = TypeValidators_1.validateType(
                  options.nameConflictBehavior,
                  Constants_1.default.TYPE_STRING,
                  true,
                  "rename"
                );
              ...
              SaverOptions.prototype.needAPICall = function () {
                return (
                  !!this.queryParameters ||
                  this.action === SaverActionType_1.default.save
                );
              };
              SaverOptions.prototype._setFileInfo = function (options) {
                if (options.sourceInputElementId && options.sourceUri) {
                  ErrorHandler_1.throwError(
                    new OneDriveSdkError_1.default(
                      ErrorType_1.default.optionsError,
                      "sourceUri and sourceInputElementId" +
                        " are provided, only one is required."
                    )
                  );
                }
                this.sourceInputElementId = options.sourceInputElementId;
                this.sourceUri = options.sourceUri;
                var fileName = TypeValidators_1.validateType(
                  options.fileName,
                  Constants_1.default.TYPE_STRING,
                  true,
                  null
                ...
                if (this.sourceUri) {
                  if (UrlUtilities_1.isPathFullUrl(this.sourceUri)) {
                    ...
                    this.fileName =
                      fileName ||
                      UrlUtilities_1.getFileNameFromUrl(this.sourceUri);
                    if (!this.fileName) {
                      ErrorHandler_1.throwError(
                        new OneDriveSdkError_1.default(
                          ErrorType_1.default.optionsError,
                  ...
                  this.fileInput = DomUtilities_1.getFileInput(
                    this.sourceInputElementId
                  );
              ...
              if (fileInputElement instanceof HTMLInputElement) {
                ...
                if (fileInput.size > FORM_UPLOAD_SIZE_LIMIT) {
                  ErrorHandler_1.throwError(
                    new OneDriveSdkError_1.default(
                      ErrorType_1.default.optionsError,
                      "the user has selected a file larger than " +
                        FORM_UPLOAD_SIZE_LIMIT_STRING
                    )
                  );
                  return null;
                }
        ...
        function (require, module, exports) {
          (function (require, exports, ErrorType_1) {
            ...
            function throwError(sdkError) {
              if (
                sdkError.errorCode !==
                ErrorType_1.default[ErrorType_1.default.unknown]
              ) {
                for (
                  var _i = 0, ERROR_HANDLERS_1 = ERROR_HANDLERS;
                  _i < ERROR_HANDLERS_1.length;
                  _i++
                ) {
        ...
        function (require, module, exports) {
          (function (require, exports, Constants_1, Logging_1) {
            ...
            function shallowClone(object) {
              if (
                typeof object !== Constants_1.default.TYPE_OBJECT ||
                !object
              ) {
                return null;
              }
            ...
            function deserializeJSON(text) {
              ...
              if (
                typeof deserializedObject !== Constants_1.default.TYPE_OBJECT ||
          ...
          (function (
            ...
            var Popup = (function () {
              ...
              Popup.createPopupFeatures = function () {
                var left =
                  window.screenX +
                  Math.max(window.outerWidth - POPUP_WIDTH, 0) / 2;
                var top =
                  window.screenY +
                  Math.max(window.outerHeight - POPUP_HEIGHT, 0) / 2;
                var features = [
                  "width=" + POPUP_WIDTH,
                  "height=" + POPUP_HEIGHT,
                  "top=" + top,
                ...
                ErrorHandler_1.throwError(
                  new OneDriveSdkError_1.default(
                    ...
                    StringUtilities_1.format(
                      ...
                      ObjectUtilities_1.serializeJSON(validValues)
                    )
                  )
                );
                return null;
        ...
        function (require, module, exports) {
          (function (
            ...
            function appendQueryString(baseUrl, queryKey, queryValue) {
              return appendQueryStrings(
                baseUrl,
                ((_a = {}), (_a[queryKey] = queryValue), _a)
              );
              var _a;
            }
            ...
            function readUrlParameters(url) {
              ...
              if (queryStart > 0) {
                var queryEnd =
                  hashStart > queryStart ? hashStart - 1 : url.length;
                deserializeParameters(
                  url.substring(queryStart, queryEnd),
                  queryParamters
                );
              }
              if (hashStart > 0) {
            ...
            function isPathFullUrl(path) {
              return (
                path.indexOf("https://") === 0 || path.indexOf("http://") === 0
              );
            }
            ...
            function validateUrlProtocol(url, protocols) {
              ...
              for (
                var _i = 0, protocols_1 = protocols;
                _i < protocols_1.length;
                _i++
              ) {
              ...
              ErrorHandler_1.throwError(
                new OneDriveSdkError_1.default(
                  ErrorType_1.default.optionsError,
                  StringUtilities_1.format(
                    "uri {0} does not match protocol(s): " + protocols,
                    url
                  )
                )
              ).exposeToPublic();
          ...
          (function (
            ...
            var XHR = (function () {
              function XHR(options) {
                ...
                this._apiEndpoint =
                  options.apiEndpoint || ApiEndpoint_1.default.msa;
              ...
              XHR.prototype._callProgressCallback = function (uploadProgress) {
                Logging_1.default.logMessage(
                  "calling xhr upload progress callback"
                );
              ...
              XHR.prototype._setHeaders = function () {
                ...
                var sdkVersion = StringUtilities_1.format(
                  "{0}={1}",
                  "SDK-Version",
                  Constants_1.default.SDK_VERSION
                );
